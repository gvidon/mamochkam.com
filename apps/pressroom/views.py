...
def index(request):
	...
	try:
		...
		return render_to_response('pressroom/index.html', locals(), context_instance=RequestContext(request))
...
def view_section(request, slug, page=1):
	...
	try:
		...
		return list_detail.object_list(request,
			...
			extra_context = {'section': section, 'galleries': Gallery.objects.all()[:3]}
		)
